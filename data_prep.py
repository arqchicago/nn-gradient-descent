...
class mnist:
    ...
    def get_vectorized_datasets(self, validation_data_pct=0.0):
        ...
        if validation_data_pct>0.0:
            ...
            n_validation_x = int(round(len(testing_data) * validation_data_pct,0))
            validation_data = testing_data[0:n_validation_x]
            testing_data = testing_data[n_validation_x:]      
...
if __name__ == "__main__":
    get_val_data = 0.0
    mnist_data = mnist()
    training_data, testing_set, validation_data = mnist_data.get_vectorized_datasets(get_val_data)
'''